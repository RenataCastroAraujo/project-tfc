Esse projeto foi desenvolvido durante o curso da Trybe. Trata-se de um projeto que traz uma tabela de campeonato, pode-se verificar os jogos em andamento e os finalizados, de acordo com a pontuação de cada time na rodada temos a classificação.
